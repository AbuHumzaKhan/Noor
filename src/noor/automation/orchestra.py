...
class UnifiedOrchestra:
    """Deterministic execution core for Noor's unified automation mind.

    Planning is intentionally separate from execution. An LLM or future planner
    may produce a TaskGraph, while this component remains responsible for
    dependency ordering, provider dispatch, retries, and result propagation.
    """
